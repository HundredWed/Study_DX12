...
void RootSignature::CreateRootSignature()
{
	...
	CD3DX12_DESCRIPTOR_RANGE ranges[] =
	{
		...
		CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, SRV_REGISTER_COUNT, 0), // t0~t4 텍스처
	};
	CD3DX12_ROOT_PARAMETER param[1];//테이블 하나
	param[0].InitAsDescriptorTable(_countof(ranges), ranges);

	D3D12_ROOT_SIGNATURE_DESC sigDesc = CD3DX12_ROOT_SIGNATURE_DESC(_countof(param), param, 1, &_samplerDesc);//D3D12_DEFAULT/*기본상태*/
